<template>
  <div>
    <el-button v-permission="permission.edit" :loading="crud.status.cu === 2" :disabled="disabledEdit" size="mini" type="primary" icon="el-icon-edit" @click="toEdit(data)" />
...
export default {
  ...
  methods: {
      toEdit(param){
          ...
          this.$router.push({name: 'CheckCardTemplateAdd', query: { param: param}})
      },
    doCancel() {
      this.pop = false

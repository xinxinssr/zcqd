...
function CRUD(options) {
  ...
  const methods = {
    ...
    doAdd() {
      ...
      //新增时间，新增人
      crud.form.createTime=new Date();
      crud.form.createBy=localStorage.getItem("username")
      crud.form.type=localStorage.getItem("supplierType")
    ...
    doEdit() {
      ...
      //修改时间，修改人
      crud.form.updateTime=new Date();
      crud.form.updateBy=localStorage.getItem("username")
    ...
    goExport(val){
      //导入
        ...
        requestPost(urls + 'supplier/Supplierupload', formData).then(result => {
          crud.refresh()
    ...
    getQueryParams: function() {
      ...
      // 清除参数无值的情况
      crud.query.type=localStorage.getItem("supplierType")
